...
Note:Use CTRL+F to go to following steps. Only Type steps like Step-01, Step-02, Step-03 ...

## Step-01
### First check **pip list**:
command:
```bash
pip list
```
See pip list like this;
<pre>
 Package              Version
-------------------- -------
asgiref              3.7.2
...
### Uninstall all Packages
 ...
 Two methodes to uninstall Packages
1. One by one uninstall all Packages
like;
```bash
...
```
 ...
 2. In one time uninstall all Packages
Enter this command 
```bash
pip uninstall asgiref  Django django-debug-toolbar mysqlclient sqlparse tzdata 
```

All packages are uninstall like this
<pre>
Found existing installation: asgiref 3.7.2
Uninstalling asgiref-3.7.2:
  Would remove:
    c:\users\hp\appdata\local\programs\python\python311\lib\site-packages\asgiref-3.7.2.dist-info\*
    c:\users\hp\appdata\local\programs\python\python311\lib\site-packages\asgiref\*
Proceed (Y/n)? y
  Successfully uninstalled asgiref-3.7.2
Found existing installation: Django 5.0.1
Uninstalling Django-5.0.1:
  Would remove:
    c:\users\hp\appdata\local\programs\python\python311\lib\site-packages\django-5.0.1.dist-info\*
    c:\users\hp\appdata\local\programs\python\python311\lib\site-packages\django\*
    c:\users\hp\appdata\local\programs\python\python311\scripts\django-admin.exe
Proceed (Y/n)? y
  Successfully uninstalled Django-5.0.1
Found existing installation: django-debug-toolbar 4.2.0
Uninstalling django-debug-toolbar-4.2.0:
  Would remove:
    c:\users\hp\appdata\local\programs\python\python311\lib\site-packages\debug_toolbar\*
    c:\users\hp\appdata\local\programs\python\python311\lib\site-packages\django_debug_toolbar-4.2.0.dist-info\*
Proceed (Y/n)? y
  Successfully uninstalled django-debug-toolbar-4.2.0
Found existing installation: mysqlclient 2.2.1
Uninstalling mysqlclient-2.2.1:
  Would remove:
    c:\users\hp\appdata\local\programs\python\python311\lib\site-packages\mysqlclient-2.2.1.dist-info\*
    c:\users\hp\appdata\local\programs\python\python311\lib\site-packages\mysqldb\*
Proceed (Y/n)? y
  Successfully uninstalled mysqlclient-2.2.1
Found existing installation: sqlparse 0.4.4
Uninstalling sqlparse-0.4.4:
  Would remove:
    c:\users\hp\appdata\local\programs\python\python311\lib\site-packages\sqlparse-0.4.4.dist-info\*
    c:\users\hp\appdata\local\programs\python\python311\lib\site-packages\sqlparse\*
    c:\users\hp\appdata\local\programs\python\python311\scripts\sqlformat.exe
Proceed (Y/n)? y
  Successfully uninstalled sqlparse-0.4.4
Found existing installation: tzdata 2023.4
Uninstalling tzdata-2023.4:
  Would remove:
    c:\users\hp\appdata\local\programs\python\python311\lib\site-packages\tzdata-2023.4.dist-info\*
    c:\users\hp\appdata\local\programs\python\python311\lib\site-packages\tzdata\*
Proceed (Y/n)? y
  Successfully uninstalled tzdata-2023.4
</pre>
-All libraries are uninstalled.
- Then you check see again pip list.
<pre>
Package  Version
-------- -------
pip      23.3.2
</pre>
- if besides that any library is installed, you must add to uninstall in this command.
- 
Note: *You do not uninstall pip* **warna aap ky sath moye moye ho jay ga**
...
## Step-04
### Again ckeck pip list, you see output;
<pre>
Package  Version
-------- -------
asgiref  3.7.2
...
class Product(models.Model):
    title = models.CharField(max_length=255, verbose_name='Product Tit')
